...
description: "Here's how to view whether or not a user is on a paid plan or not."
---
...
You can also listen for subscription status changes using `useSuperwallEvents`:
