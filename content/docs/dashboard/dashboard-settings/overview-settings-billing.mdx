...
<Frame>![](/images/overview-settings-billing.webp)</Frame>
...
<Frame>![](/images/overview-settings-billing-add.webp)</Frame>

From there, you can manually enter in your card details:

<Frame>![](/images/overview-settings-billing-enter.webp)</Frame>

Or, you can use the Autofill Link service by clicking the green "Autofill Link" button:

<Frame>![](/images/overview-settings-billing-autofill.webp)</Frame>
