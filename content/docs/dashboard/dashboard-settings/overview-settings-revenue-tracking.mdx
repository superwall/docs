...
<Frame>![](/images/overview-settings-rev-tracking.png)</Frame>

## Status

Your revenue tracking status will be listed at the top, indicating if you've successfully set it up or not:

<Frame>![](/images/overview-settings-rev-tracking-status.png)</Frame>
...
<Frame>![](/images/overview-settings-rev-tracking-setup-server.png)</Frame>

For the URL, use the value in Superwall that was prefilled by clicking the copy button:

<Frame>![](/images/overview-settings-rev-tracking-url.png)</Frame>

Then, enter this in App Store Connect modal:

<Frame>![](/images/overview-settings-rev-tracking-v2.png)</Frame>
...
<Frame>![](/images/overview-settings-rev-tracking-iaps.png)</Frame>
...
<Tabs>
  ...
  <Tab title="Step 3">
    ...
    <Frame>![](/images/overview-settings-rev-tracking-confirm.png)</Frame>
  </Tab>
  <Tab title="Step 4">
...
<Frame>![](/images/overview-settings-rev-tracking-asc-api.png)</Frame>
...
<Tabs>
  ...
  <Tab title="Step 3">
    ...
    <Frame>![](/images/overview-settings-rev-tracking-asc-api-download.png)</Frame>
  </Tab>
  <Tab title="Step 4">
    - Upload the key file you downloaded in the previous step to Superwall under "P8 Key File." -
    ...
    <Frame>![](/images/overview-settings-rev-tracking-asc-api-key-id.png)</Frame>- For **Issuer ID**,
...
<Frame>![](/images/rcLinkStep1.jpeg)</Frame>

In Superwall, those have been linked together as a project:

<Frame>![](/images/rcLinkStep2.jpeg)</Frame>
