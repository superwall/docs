...
<Frame>![](/images/overview-settings-team.webp)</Frame>
...
<Frame>![](/images/overview-settings-team-invite.webp)</Frame>

From there, fill out the details (name and email address) and **click** the **Invite** button:

<Frame>![](/images/overview-settings-invite-modal.webp)</Frame>
...
<Frame>![](/images/overview-settings-team-rename.webp)</Frame>
