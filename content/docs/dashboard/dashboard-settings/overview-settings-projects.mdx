...
<Frame>![](/images/overview-settings-projects.png)</Frame>
...
<Frame>![](/images/overview-settings-project-new.png)</Frame>

From there, give it a name and **click** the **Save** button:

<Frame>![](/images/overview-settings-create-project.png)</Frame>
...
<Frame>![](/images/overview-settings-project-details.png)</Frame>
