...
- **Add Paddle products:** Follow the combined [product guide](/dashboard/web-checkout/web-checkout-adding-a-stripe-product) for Stripe and Paddle.
- **Build paywalls and campaigns:** Continue with [Creating campaigns to show paywalls](/dashboard/web-checkout/web-checkout-creating-campaigns-to-show-paywalls).
- **Test purchases:** Use the Paddle sandbox credentials with [Testing purchases](/dashboard/web-checkout/web-checkout-testing-purchases).
