...
<Frame>![](/images/web2app_create_product.png)</Frame>

<Note>
  Complete your provider setup first:
  
  - **Stripe:** Follow the steps in [Configuring Stripe Keys and Settings](/dashboard/web-checkout/web-checkout-configuring-stripe-keys-and-settings).
  - **Paddle (private beta):** Follow the steps in [Configuring Paddle Keys and Settings](/dashboard/web-checkout/web-checkout-paddle-setup).
</Note>

Next, **click** on the **+ Import Products** button in the top right corner:

<Frame>![](/images/web2app_import.png)</Frame>
...
<Frame>![](/images/web2app_import_ctx.png)</Frame>
...
<Frame>![](/images/web2app_entitlement.png)</Frame>
...
<Frame>![](/images/web2app_create_stripe_product.png)</Frame>{" "}
...
<Frame>![](/images/web2app_create_new_product_in_stripe.png)</Frame>
...
<Frame>![](/images/web2app_product_redirect.png)</Frame>
...
<Frame>![](/images/web2app_add_product.png)</Frame>

Keep in mind that to test products, it's as simple as adding a test product to a paywall and performing the checkout flow. For more information, please refer to [Testing purchases](/dashboard/web-checkout/web-checkout-testing-purchases).
...
<Frame>![](/images/web2app_sandbox_product.png)</Frame>
...
<Frame>![](/images/web2app_products_test_prod.png)</Frame>
...
<Frame>![](/images/web2app_sandbox_overview.png)</Frame>
