...
<Frame>![](/images/overview-users-sidebar.webp)</Frame>
...
<Frame>![](/images/overview-users-toggle-by-event.webp)</Frame>

### Searching by user identifier

If you need to find a specific user, use the search box at the top:

<Frame>![](/images/overview-users-search.webp)</Frame>
...
<Frame>![](/images/overview-users-main-view.webp)</Frame>
...
<Frame>![](/images/overview-users-profile.webp)</Frame>
...
<Frame>![](/images/overview-users-toggle.webp)</Frame>
...
<Frame>![](/images/overview-users-toggle-metadata.webp)</Frame>