...
<Frame>![](/images/paywall-editor-nav-element.webp)</Frame>
...
<Frame>![](/images/paywall-editor-nav-width.webp)</Frame>

From there, add in content to create pages using [stacks](/paywall-editor-stacks):

<Frame>![](/images/paywall-editor-nav-stacks.webp)</Frame>
...
<Frame>![](/images/paywall-editor-nav-vars.webp)</Frame>
...
<Frame>![](/images/paywall-editor-nav-transition.webp)</Frame>
