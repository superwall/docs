...
<Frame>![](/images/pe-editor-dynamic-value-edit.webp)</Frame>
...
<Frame>![](/images/pe-editor-dynamic-values-step-one.webp)</Frame>
...
<Frame>![](/images/freeTrialDetection.webp)</Frame>
...
<Tabs>
  <Tab title="No Conditions">
    ...
    <br />
    <Frame>![](/images/pe-editor-dynamic-values-no-condition.webp)</Frame>
  </Tab>
  <Tab title="A Single Rule">
    If the product has an introductory offer, the text component will read "Try for free".
    <br />
    <Frame>![](/images/pe-editor-dynamic-values-step-two.webp)</Frame>
  </Tab>
  <Tab title="Using a Group">
    ...
    <br />
    <Frame>![](/images/pe-editor-dynamic-values-group.webp)</Frame>
  </Tab>
  <Tab title="Using Both">
    ...
    <br />
    <Frame>![](/images/pe-editor-dynamic-values-combo.webp)</Frame>
  </Tab>
</Tabs>
