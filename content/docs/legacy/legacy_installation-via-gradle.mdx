---
title: "Android - Gradle (Legacy)"
sidebarTitle: "Android - Gradle"
description: Install the Superwall Android SDK via Gradle. To see the latest release, [check out the repository](https://github.com/superwall/Superwall-Android).
---
...
<Frame>![](/../images/installation/build-gradle-app.webp)</Frame>
...
<Frame>![](/../images/installation/gradle-sync-now.webp) </Frame>

<br />

Go to your `AndroidManifest.xml` and add the following permissions:

<Frame>![](/../images/installation/manifest-permissions.webp)</Frame>
...
<Frame>![](/../images/installation/manifest-activity.webp)</Frame>
