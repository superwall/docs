...
<Frame>![](/../images/presentPaywallEx.webp)</Frame>
...
<Steps>
  <Step title="Add a Custom Placement Tap Behavior">
    ...
    <Frame>![](/../images/customPlacementLink.webp)</Frame>
  ...
  <Step title="Create a campaign for the other paywall to show">
    ...
    <Frame>![](/../images/customPlacementCampaign.webp)</Frame>
  ...
  <Step title="Add the placement">
    ...
    <br />
    <Frame>![](/../images/customPlacementCreate.webp)</Frame>
  </Step>
  ...
  <br />
  <Frame>![](/../images/customPlacementPaywall.webp)</Frame>
</Step>
...
<Steps>
  ...
  <Step title="Trigger the deep link from an existing paywall">
    ...
    <Frame>![](/../images/openPaywallParams.webp)</Frame>
  ...
  <Step title="Edit the audience filter">
    ...
    <br />
    <Frame>![](/../images/openPaywallParamsEditor.webp)</Frame>
    ...
    <br />
    <Frame>![](/../images/openPaywallParamsCreate.webp)</Frame>
    ...
    <br />
    <Frame>![](/../images/openPaywallFinal.webp)</Frame>

  </Step>
  <Step title="Choose a paywall to show">
  Finally, choose a paywall that should present by **clicking** on the **Paywalls** button at the top:
  <br />
  <Frame>![](/../images/openPaywallPaywall.webp)</Frame>
</Step>
</Steps>
